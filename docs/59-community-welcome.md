...
- 贡献之前请阅读 [CONTRIBUTING](https://github.com/progressorZ/ecom-style-link-agent/blob/main/CONTRIBUTING.md) 与 [CODE_OF_CONDUCT](https://github.com/progressorZ/ecom-style-link-agent/blob/main/CODE_OF_CONDUCT.md)。
- 不要上传 Cookie、账号信息、二维码、店铺身份、订单、真实商品图片或完整的 `data` 目录。漏洞请通过 [私密安全报告](https://github.com/progressorZ/ecom-style-link-agent/security/advisories/new) 提交。
