...
- [x] 确认项目名称、仓库地址和维护者联系方式：`progressorZ/ecom-style-link-agent`，安全问题通过 GitHub 私密漏洞报告。
...
- [x] 给当前 Adapter 设置真实维护者 @progressorZ；仍维持 `beta`，直至 Windows 实机和平台实页验收。
- [x] 创建 `v0.1.2-beta` 预发布及变更说明，明确只有拼多多女装 T 恤 MVP 可运行。
- [x] 已发布 [v0.1.2 Beta 发行页](https://github.com/progressorZ/ecom-style-link-agent/releases/tag/v0.1.2-beta) 和 [发布说明](58-v0.1.2-release-notes.md)。
