...
const steps=[
 ['MVP 输入、接口、备份与人工审核回归',['--test','scripts/mvp-entry.test.mjs','scripts/live-server.test.mjs','scripts/static-server.test.mjs','scripts/pdd-review.test.mjs','scripts/workbench-backup.test.mjs']],
